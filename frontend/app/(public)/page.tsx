        ...
        >
          ...
          {heroBooks.map((book) => (
            <SwiperSlide key={book._id}>
              <div className="relative overflow-hidden bg-gradient-to-br from-[#12100D] via-[#1E1A14] to-[#2a200a] min-h-[600px] md:min-h-[680px] flex items-center">
                {/* BG image blurred */}
                <div className="absolute inset-0 z-0">
                  <Image src={book.coverUrl} alt="" fill className="object-cover scale-105 blur-sm opacity-25 saturate-50" sizes="100vw" />
                  <div className="absolute inset-0 bg-gradient-to-r from-[#12100D]/95 via-[#12100D]/80 to-transparent" />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#12100D]/60 to-transparent" />
                </div>
                ...
                <div className="container-page py-20 md:py-28 grid md:grid-cols-2 gap-12 items-center relative z-10">
                  <div className="text-white">
                    <div className="flex items-center gap-2 mb-5">
                      ...
                      <span className="px-2 py-0.5 rounded-pill text-[10px] font-bold bg-white/10 text-white/70">{book.contentRating}</span>
                    </div>
                    <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-semibold leading-tight mb-5">{book.title}</h1>
                    <p className="text-white/70 font-body text-base mb-2">By <span className="text-white/90 font-semibold">{book.authorName}</span></p>
                    <p className="text-white/55 font-body text-sm leading-relaxed mb-8 max-w-lg line-clamp-3">{book.synopsis}</p>
                    <div className="flex flex-wrap gap-5 mb-9 text-sm font-mono">
                      ...
                      <span className="text-white/50">{book.chapterCount} chapters</span>
                      <span className="text-white/50">{book.freeChapterCount} free</span>
                    </div>
                    <div className="flex flex-wrap gap-3">
                      <Button href={`/book/${book._id}`} size="lg" variant="primary">Start reading free</Button>
                      <Button href={`/book/${book._id}`} size="lg" variant="ghost" className="!text-white/70 hover:!text-white hover:!bg-white/10">View details</Button>
                    </div>
                  </div>
                  ...
                  <div className="hidden md:flex justify-center">
                    <div className="relative w-52 h-[320px]">
                      <div className="absolute inset-0 translate-x-5 translate-y-5 rounded-xl bg-white/5 border border-white/10" />
                      <div className="absolute inset-0 translate-x-2.5 translate-y-2.5 rounded-xl bg-white/8 border border-white/10" />
                      <div className="relative w-full h-full rounded-xl overflow-hidden border border-white/20 shadow-elevated">
          ...
          <SwiperSlide key="author-cta">
            <div className="relative overflow-hidden min-h-[600px] md:min-h-[680px] flex items-center">
              {/* Rich dark background */}
              <div className="absolute inset-0 bg-gradient-to-br from-[#0D0B08] via-[#1A1408] to-[#261E0A]" />
              ...
              <div className="container-page py-20 md:py-28 relative z-10">
                <div className="max-w-3xl mx-auto text-center">
                  ...
                  {/* Badge */}
                  <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-pill bg-[#C9952A]/15 border border-[#C9952A]/30 text-[#D4AF37] text-xs font-semibold font-body mb-6 tracking-wide">
                  ...
                  <div className="flex flex-wrap items-center justify-center gap-3 mb-10">
                    {['Free to publish', 'Keep 70% royalty', 'Chapter-by-chapter', 'Built-in audience', 'Analytics dashboard'].map((f) => (
                      <span key={f} className="px-3 py-1 rounded-pill border border-[#C9952A]/30 bg-[#C9952A]/10 text-[#D4AF37] text-xs font-semibold font-body">{f}</span>
                    ))}
                  </div>

                  <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <Button href="/register" size="lg" variant="primary">Start writing — it&apos;s free</Button>
                    <Button href="/author/dashboard" size="lg" variant="ghost" className="!text-white/60 hover:!text-white hover:!bg-white/10">
