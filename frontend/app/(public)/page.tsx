                ...
                <div className="container-page py-20 md:py-28 grid md:grid-cols-2 gap-12 items-center relative z-10">
                  <div className="text-hero-text-title">
                    <div className="flex items-center gap-2 mb-5">
                      ...
                      <span className="px-2 py-0.5 rounded-pill text-[10px] font-bold bg-hero-badge-bg text-hero-text-body">{book.contentRating}</span>
                    </div>
                    <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-semibold leading-tight mb-5 text-hero-text-title">{book.title}</h1>
                    <p className="text-hero-text-body font-body text-base mb-2">By <span className="text-hero-text-title font-semibold">{book.authorName}</span></p>
                    <p className="text-hero-text-body/80 font-body text-sm leading-relaxed mb-8 max-w-lg line-clamp-3">{book.synopsis}</p>
                    <div className="flex flex-wrap gap-5 mb-9 text-sm font-mono">
                      <span className="flex items-center gap-1.5 text-hero-text-body">
                        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                        {formatCount(book.views)}
                      </span>
                      <span className="text-[#D4AF37] font-bold">{book.ratingAvg.toFixed(1)} ★</span>
                      <span className="text-hero-text-body/75">{book.chapterCount} chapters</span>
                      <span className="text-hero-text-body/75">{book.freeChapterCount} free</span>
                    </div>
            ...
            <div className="relative overflow-hidden min-h-[600px] md:min-h-[680px] flex items-center bg-gradient-to-br from-author-cta-from via-author-cta-via to-author-cta-to">
              ...
              <div className="container-page py-20 md:py-28 relative z-10">
                <div className="max-w-3xl mx-auto text-center">
                  ...
                  <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-semibold leading-tight text-author-cta-text mb-6">
                    Your story deserves
                  ...
                  <p className="text-author-cta-muted font-body text-base md:text-lg leading-relaxed mb-10 max-w-xl mx-auto">
